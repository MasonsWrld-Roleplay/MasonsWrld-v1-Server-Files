...
Config.CCTVCameras = { -- CCTV Cameras
    ...
    jobs = {            -- Jobs & minimum ranks that can add/modify/delete CCTV Cameras
        ...
        police = 2,     -- Job 'police' with minimum rank 0
...
Config.Locations = {
    LSPD = {
        ...
        clockInAndOut = {
            ...
            coords = vec3(439.89, -984.1, 30.69), -- Location of where to go on and off duty(If not using target)
        ...
        bossMenu = {
            ...
            coords = vec3(462.07, -1007.14, 35.93), -- Location of boss menu (If not using target)
        ...
        armoury = {
            ...
            coords = vec3(461.39, -979.64, 30.69 - 1.0),                                                 -- Coords of armoury
            ...
            weapons = {
                [0] = {                                                                                  -- Grade number will be the name of each table(this would be grade 0)
                    { name = 'WEAPON_FLASHLIGHT', label = 'Flashlight',      multiple = false, price = 75 }, -- Set price to false if undesired
                    { name = 'handcuffs',         label = 'Handcuffs',   multiple = false, price = 50 },
                    { name = 'WEAPON_STUNGUN',    label = 'Tazer',   multiple = false, price = 50 },
                },
                ...
                [5] = { -- This would be grade 1
                    { name = 'WEAPON_FLASHLIGHT', label = 'Flashlight',      multiple = false, price = 75 }, -- Set price to false if undesired
                    { name = 'handcuffs',         label = 'Handcuffs',   multiple = false, price = 50 },
                    { name = 'WEAPON_STUNGUN',    label = 'Tazer',   multiple = false, price = 50 },
                },
                [6] = { -- This would be grade 2
                    { name = 'WEAPON_FLASHLIGHT', label = 'Flashlight',      multiple = false, price = 75 }, -- Set price to false if undesired
                    { name = 'handcuffs',         label = 'Handcuffs',   multiple = false, price = 50 },
                    { name = 'WEAPON_STUNGUN',    label = 'Tazer',   multiple = false, price = 50 },
                    { name = 'WEAPON_COMBATPISTOL', label = 'Pistol',   multiple = false, price = 50 },
                    { name = 'ammo-9',            label = 'Pistol Ammo',   multiple = false, price = 50 },
                },
                [7] = { -- This would be grade 3
                    { name = 'WEAPON_FLASHLIGHT', label = 'Flashlight',      multiple = false, price = 75 }, -- Set price to false if undesired
                    { name = 'handcuffs',         label = 'Handcuffs',   multiple = false, price = 50 },
                    { name = 'WEAPON_STUNGUN',    label = 'Tazer',   multiple = false, price = 50 },
                    { name = 'WEAPON_COMBATPISTOL', label = 'Pistol',   multiple = false, price = 50 },
                ...
                [8] = { -- This would be grade 1
                    { name = 'WEAPON_FLASHLIGHT', label = 'Flashlight',      multiple = false, price = 75 }, -- Set price to false if undesired
                    { name = 'handcuffs',         label = 'Handcuffs',   multiple = false, price = 50 },
                    { name = 'WEAPON_STUNGUN',    label = 'Tazer',   multiple = false, price = 50 },
                    { name = 'WEAPON_COMBATPISTOL', label = 'Pistol',   multiple = false, price = 50 },
                    { name = 'ammo-9',            label = 'Pistol Ammo',   multiple = false, price = 50 },
                    { name = 'WEAPON_CARBINERIFLE', label = 'Carbine Rifle',   multiple = false, price = 50 },
                    { name = 'ammo-rifle',        label = 'Rifle Ammo',   multiple = false, price = 50 },
                },
                [9] = { -- This would be grade 2
                    { name = 'WEAPON_FLASHLIGHT', label = 'Flashlight',      multiple = false, price = 75 }, -- Set price to false if undesired
                    { name = 'handcuffs',         label = 'Handcuffs',   multiple = false, price = 50 },
                    { name = 'WEAPON_STUNGUN',    label = 'Tazer',   multiple = false, price = 50 },
                    { name = 'WEAPON_COMBATPISTOL', label = 'Pistol',   multiple = false, price = 50 },
        ...
        evidenceLocker = {
            ...
            jobLock = 'police',                   -- Job lock?
            coords = vec3(472.6, -984.78, 24.92), -- Area to prompt personal locker
            range = 2.0,                          -- Range it will prompt from coords above
