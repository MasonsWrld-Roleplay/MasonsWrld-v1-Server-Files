Config = {
    ...
    Inventory = Inventories.AUTO_DETECT,          -- [OX - ox_inventory, QB - qb-inventory, QS - qs-sinventory, MF - mf-inventory, PS - qb-inventory, LJ - lj-inventory, CORE = core_inventory]
    ...
    Text = {
        Position = 'right-center', -- This is the position of the text ['top-left', 'top-right', 'bottom-left', 'bottom-right']
    },
    ...
    ImagePath = {
        ...
        [Inventories.PS] = 'nui://qb-inventory/html/images',
