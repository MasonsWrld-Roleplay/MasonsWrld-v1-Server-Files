CreateThread(function()
    if isBridgeLoaded('Framework', Framework.QBCore) then
        ...
        function Framework.canStartPrisonBreak()
            ...
            if isResourceLoaded(THIRD_PARTY_RESOURCE.WASABI_POLICE) then
                if officers and officers >= Config.Escape.RequiredPolice then
                    retval = true
                end
            else
                if officers and next(officers) then
                    ...
                    if size >= Config.Escape.RequiredPolice then
                        retval = true
                    end
                end
            end
