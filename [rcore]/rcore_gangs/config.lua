...
Config.GangOptions = {
    ...
    storageSlots = 160, -- Sets the number of slots in gang storage
    storageWeight = 9000000000, -- Sets the maximum weight of gang storage
    ...
    maxMembers = 12, -- Maximum number of players in a gang
