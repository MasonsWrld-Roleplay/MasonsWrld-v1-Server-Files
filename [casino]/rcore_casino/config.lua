Config = {
    ...
    MoneyInventoryItemName = cash, -- name of the money inventory item, set to nil, if you don't want to use inventory item as the money
    ...
    IT_LOCAL_RACE_MAX_BET = 7500, -- max. bet for the local race
