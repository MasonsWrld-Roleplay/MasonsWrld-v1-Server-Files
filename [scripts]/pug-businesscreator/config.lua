...
------------------------------
---------- [STRINGS] ----------
Config.inventoryImagesDirectoryPath = "resources/[Inventory]/qs-inventory/html/images/" -- Image directory path to your inventory script so that images can be saved to it when you make new items.
...
Config.PullItemsFromOXInventory = true -- Make this true if you are qbcore and want the items list to be from the items in your ox_inventory script. (I DO NOT RECCOMEND THIS AT ALL AS ITS THE WRONG WAY TO DO YOUR SERVER)
...
---------- [INTAGERS] ----------
Config.WorkersCommission = 0.00 -- (%) 10 % of the total register sale gets devided by all workers on duty and within the radiuis of the physical business location. 
Config.BusinessCommission = 0.00 -- (%) 30 % is the commision that goes to the business of each register sale
Config.BillerCommission = 100.00 -- (%) 5 % is the commision that goes to the worker who makes the sale at the register (they also get the Config.WorkersCommission so in total 15 %)
