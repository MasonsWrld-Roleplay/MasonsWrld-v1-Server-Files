	...
	for k, v in pairs(AllCraftableData) do
		...
		if Config.Menu == "ox_lib" then
			...
			elseif Config.InventoryType == "codem-inventory" then
				Image = 'https://cfx-nui-'..Config.InventoryType..'/itemimages/'..GetItemsInformation(AllCraftableData[k].MainIngredientItem, true)
				Icon = 'https://cfx-nui-'..Config.InventoryType..'/itemimages/'..GetItemsInformation(AllCraftableData[k].MainIngredientItem, true)
			end
...
RegisterNetEvent("Pug:client:CraftBusinessItem", function(Data)
	...
	if Config.UseProgressBar then
		if Config.UseProgressBar == "ox_lib" then
    ...
    if Config.Menu == "ox_lib" then
		...
		if StockedData then
			for k, v in pairs(StockedData) do
				...
				elseif Config.InventoryType == "codem-inventory" then
					Image = 'https://cfx-nui-'..Config.InventoryType..'/itemimages/'..GetItemsInformation(v.item, true)
					Icon = 'https://cfx-nui-'..Config.InventoryType..'/itemimages/'..GetItemsInformation(v.item, true)
				end
				local Durability = ""
				local MainMetaData
		...
		if StockedData then
			for k, v in pairs(StockedData) do
				local Image = false
				local Image2 = 'https://cfx-nui-'..Config.InventoryType..'/html/images/'..v.item..'.png'
				if Config.InventoryType == "ox_inventory" then
					Image2 = 'https://cfx-nui-ox_inventory/web/images/'..v.item..'.png'
					Image = GetItemsInformation(v.item, true)
					if not string.find(Image, ".png") then
						Image = Image..".png"
					end
				end
