...
DP.PropEmotes = {
    ...
    ["safer_tora_01"] = {"anim@heists@box_carry@", "idle", "safer tora 01", AnimationOptions =
    {
        Prop = 'radoofz_synagogue_safer_tora_01',
        PropBone = 24817,
        PropPlacement = {-0.29, 0.40, -0.02, -90.0, -90.0, 0.0},
        EmoteMoving = true,
        EmoteLoop = true
    }},
    ["safer_tora_02"] = {"anim@heists@box_carry@", "idle", "safer tora 02", AnimationOptions =
    {
        Prop = 'radoofz_synagogue_safer_tora_02',
        PropBone = 24817,
        PropPlacement = {-0.29, 0.40, -0.02, -90.0, -90.0, 0.0},
        EmoteMoving = true,
        EmoteLoop = true
    }},
    ["safer_tora_03"] = {"anim@heists@box_carry@", "idle", "safer tora 03", AnimationOptions =
    {
        Prop = 'radoofz_synagogue_safer_tora_03',
        PropBone = 24817,
        PropPlacement = {-0.29, 0.40, -0.02, -90.0, -90.0, 0.0},
        EmoteMoving = true,
        EmoteLoop = true
    }},
    ["safer_tora_04"] = {"anim@heists@box_carry@", "idle", "safer tora 04", AnimationOptions =
    {
        Prop = 'radoofz_synagogue_safer_tora_04',
        PropBone = 24817,
        PropPlacement = {-0.29, 0.40, -0.02, -90.0, -90.0, 0.0},
        EmoteMoving = true,
        EmoteLoop = true
