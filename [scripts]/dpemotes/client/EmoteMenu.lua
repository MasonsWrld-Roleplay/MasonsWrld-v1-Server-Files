...
--[[ function AddInfoMenu(menu)
    ...
    infomenu:AddItem(NativeUI.CreateItem("Thanks ~o~CUSTOM~s~", "~o~CUSTOM~s~ for the original dpemotes ❤️"))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <b>CUSTOM</b>",
        "<b>CUSTOM</b> for the addition of Animal Emotes 🐩 submenu."))
    infomenu:AddItem(NativeUI.CreateItem("Thanks ~r~CUSTOM~s~",
        "~r~CUSTOM~s~ for reformatting and assisting with code and additional features 🙏"))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <font color=\"#3b8eea\">CUSTOM</font>",
        "<font color=\"#3b8eea\">CUSTOM</font> for the custom pride flags 🏳️‍🌈."))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <font color=\"#a356fa\">CUSTOM</font>",
        "<font color=\"#a356fa\">CUSTOM</font> for the custom emotes 💜."))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <font color=\"#ff00c3\">CUSTOM</font>",
        "<font color=\"#ff00c3\">CUSTOM</font> for assisting with attached Shared Emotes ⚙️."))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <font color=\"#7dbf7b\">CUSTOM</font>",
        "<font color=\"#7dbf7b\">CUSTOM</font> for the custom emotes 🐇."))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <font color=\"#FF6100\">CUSTOM</font>",
        "<font color=\"#FF6100\">CUSTOM</font> for the custom emotes 🤙🏼."))
    infomenu:AddItem(NativeUI.CreateItem("Thanks ~b~CUSTOM~s~", "~b~CUSTOM~s~ for the custom emotes ☺️."))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <font color=\"#37DA00\">CUSTOM</font>",
        "<font color=\"#37DA00\">CUSTOM</font> for the custom food props 🍩."))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <font color=\"#C40A7D\">CUSTOM</font>",
        "<font color=\"#C40A7D\">CUSTOM</font> for the custom lollipop props 🍭."))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <font color=\"#189FD0\">CUSTOM</font>",
        "<font color=\"#189FD0\">CUSTOM</font> for the search feature 🔎."))
    infomenu:AddItem(NativeUI.CreateItem("Thanks <font color=\"#ff61a0\">CUSTOM</font>",
        "<font color=\"#ff61a0\">CUSTOM</font> for all da shit ☺️."))
...
RegisterNetEvent("dp:cancelEmote") -- For opening the emote menu from another resource.
