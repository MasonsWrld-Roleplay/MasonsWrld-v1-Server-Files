...
if Config.EnableXtoCancel then
    RegisterKeyMapping("emotecancel", "Cancel Emote", "keyboard", "X")
end

if Config.MenuKeybindEnabled then
    RegisterKeyMapping("emotemenu", "Open Emote Menu", "keyboard", Config.MenuKeybind)
end
...
exports("EmoteCommandStart", function()
    if CanDoEmote then
        EmoteCommandStart(source, args)
      else
