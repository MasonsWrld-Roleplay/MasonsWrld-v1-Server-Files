...
Config.Companies.Services = {
    {
        job = "police",
        name = "Evolution Police Department",
...
Config.Locations = { -- Locations that'll appear in the maps app.
{
    ...
    name = "EPD",
    description = "Evolution Network Police Department",
    icon = "https://cdn-icons-png.flaticon.com/512/7211/7211100.png",
},
{
    position = vector2(304.2, -587.0),
    name = "EHS",
    description = "Evolution Network Health Service",
    icon = "https://cdn-icons-png.flaticon.com/128/1032/1032989.png",
},
}
...
Config.CityName = "Evolution Network" -- The name that's being used in the weather app etc.
...
Config.EmailDomain = "evolution.com"
...
Config.Camera.MaxFOV = 100.0 -- higher = zoomed out
Config.Camera.MinFOV = 5.0 -- lower = zoomed in
Config.Camera.MaxLookUp = 90.0
Config.Camera.MaxLookDown = -90.0

Config.Camera.Vehicle = {}
Config.Camera.Vehicle.Zoom = true -- allow zooming in vehicles?
Config.Camera.Vehicle.MaxFOV = 100.0
Config.Camera.Vehicle.MinFOV = 5.0
Config.Camera.Vehicle.MaxLookUp = 70.0
Config.Camera.Vehicle.MaxLookDown = -40.0
