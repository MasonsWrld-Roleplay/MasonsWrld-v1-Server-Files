...
Config.VMSTattooShop = GetResourceState('vms_tattooshop') ~= 'missing'
Config.VMSBarberShop = GetResourceState('vms_barber') ~= 'missing'
Config.VMSClotheStore = GetResourceState('vms_clothestore') ~= 'missing'
