...
local function ShowBlip(blipConfig, blip)
    ...
    if Config.VMSTattooShop and blip.type == "tattoo" then
        return false
    end
    if Config.VMSBarberShop and blip.type == "barber" then
        return false
    end
    if Config.VMSClotheStore and blip.type == "clothing" then
        return false
    end
