...
local function SetupZone(store, onEnter, onExit)
    if Config.VMSTattooShop and store.type == "tattoo" then
        return {}
    end
    if Config.VMSBarberShop and store.type == "barber" then
        return {}
    end
    if Config.VMSClotheStore and store.type == "clothing" then
        return {}
    end
