...
local Webhook = 'https://discord.com/api/webhooks/1274215109719494726/S41my_uwmskXIdRFbEGcP3IB8sO8kxVB9l-WwmVElXY06ZO3ypzALqs1inNdK9ov--a-'
...
function AddMoney(society, amount)
	...
	MySQL.query('UPDATE okokbanking_societies SET value = value + @value WHERE society = @society OR society = @society2', {
		['@value'] = amount,
