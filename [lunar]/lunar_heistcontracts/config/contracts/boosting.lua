    ...
    classes = {
        {
            ...
            chance = 50,
            price = 0,
            reward = { money = { min = 10000, max = 12000 }, crypto = 5, experience = 25 },
            hasTracker = false,
            cars = {
                `tornado`,
                `tornado2`,
        ...
        },
        {
            ...
            chance = 25,
            price = 0,
            reward = { money = { min = 12000, max = 17000 }, crypto = 7, experience = 40 },
            hasTracker = false,
            cars = {
                `futo`,
                `glendale`,
        ...
        },
        {
            ...
            chance = 20,
            price = 10,
            reward = { money = { min = 17000, max = 25000 }, crypto = 15, experience = 60 },
            hasTracker = true,
            cars = {
                `komoda`,
                `jugular`,
        ...
        },
        {
            ...
            chance = 3,
            price = 20,
            reward = { money = { min = 25000, max = 60000 }, crypto = 20, experience = 80 },
            hasTracker = false,
            cars = {
                `comet4`,
                `comet5`,
        ...
        },
        {
            ...
            chance = 2,
            price = 50,
            reward = { money = { min = 60000, max = 75000 }, crypto = 25, experience = 100 },
            hasTracker = true,
            cars = {
                `autarch`,
                `cheetah2`,
        ...
        },
        {
            ...
            chance = 1,
            price = 75,
            reward = { money = { min = 75000, max = 100000 }, crypto = 50, experience = 150 },
            hasTracker = true,
            cars = {
                `thrax`,
                `tigon`,
