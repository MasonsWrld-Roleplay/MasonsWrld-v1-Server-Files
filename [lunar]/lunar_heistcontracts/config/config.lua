...
Config.ped = {
    ...
    ---@type ShopBuyItem[]
    buyItems = {
        { name = 'angle_grinder', description = locale('angle_grinder_description'), price = { money = 1000, crypto = 75 }, stock = 3, chance = 25},
        { name = 'hack_usb', description = locale('hack_usb_description'), price = { money = 1250, crypto = 100 }, stock = 5, chance = 55 },
        { name = 'hack_card', description = locale('hack_card_description'), price = { money = 2000, crypto = 150 }, stock = 5, chance = 75 },
        { name = 'thermite', description = locale('thermite_description'), price = { money = 250, crypto = 20 }, stock = 5, chance = 25 },
        { name = 'large_drill', description = locale('large_drill_description'), price = { money = 5000, crypto = 200 }, stock = 3, chance = 15 },
        { name = 'weapon_digiscanner', description = locale('signal_booster_description'), price = { money = 2500, crypto = 125 }, stock = 3 },
        { name = 'bomb_c4', description = locale('bomb_c4_description'), price = { money = 7500, crypto = 200 }, stock = 2, chance = 25 },
    },
    sellAccount = 'money',
    ---@type ShopSellItem[]
    sellItems = {
