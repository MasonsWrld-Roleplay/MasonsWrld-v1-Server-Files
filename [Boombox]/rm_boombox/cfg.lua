Config = {
    ...
    apiKey = "AIzaSyCLDirr05_6ztVhNKR9WctG5mz37enx__g",-- ENTER API KEY (https://youtu.be/LLAZUTbc97I)
    boomboxLimit = 3, -- maximum boombox in server
    syncCooldown = 15, -- 15 seconds
    removeCommand = "rboombox",
    streamerCommand = "smboombox",
    staffList = {
        ["steam:110000"] = true
    },
    boomboxes = {
        ["boombox_white_large"] = {
            ...
            maxDistance = 60, -- maximum sound hearing distance
...
Strings = {
    ...
    ["streamer_mode_disabled"] = "Streamer Mode Disabled",
}
