...
Config.BossMenus = {
    ...
    ['taco'] = {
        vector3(369.44, -1595.46, 37.23),
    },
    ['cookies'] = {
        vector3(-934.1, -1168.34, 5.11), 
    },
    ['mcdonalds'] = {
        vector3(84.49, 293.66, 110.21), 
    },
    ['galaxy'] = {
        vector3(408.24, 244.38, 92.05), 
    },
...
Config.BossMenuZones = {
    ...
    ['taco'] = {
        {coords = vector3(369.44, -1595.46, 37.23), length = 1.15, width = 2.6, heading = 353.0, minZ = 4.11, maxZ = 5.99},
    },

    ['mcdonalds'] = {
        {coords = vector3(84.42, 293.6, 110.21), length = 1.15, width = 2.6, heading = 353.0, minZ = 4.11, maxZ = 5.99},
    },

    ['galaxy'] = {
        {coords = vector3(408.24, 244.38, 92.05), length = 1.15, width = 2.6, heading = 353.0, minZ = 4.11, maxZ = 5.99},
    },
