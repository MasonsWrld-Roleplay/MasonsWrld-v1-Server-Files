...
-- Available options are: 'qb-phone', 'npwd', 'qs-smartphone', 'qs-smartphonepro',
-- 'lb-phone', 'gksphone', 'yseries', 'roadphone', 'custom' or 'none'
...
-- The request option below is how long the client should wait for a model/anim to load
...
Config.Police = {
    ...
    -- The "chance" below is the percentage chance cops receive a dispatch alert
    -- When a chop vehicle has been succesfully lockpicked
    chance = 100
}
...
-- The ped model used for the starting location ped
Config.StartModel = 'a_m_m_bevhills_01'
...
Config.Shops = {
    ...
    swapShop = {
        ...
        items = {
            ...
            -- min: minimum amount the player must purchase at once
            -- max: maximum amount the player can purchase at once
            [1] = { item = 'metalscrap', price = 1, label = 'metalscrap', icon = 'metalscrap', iconColor = '', quantity = 3, min = 5, max = 5 },
            [2] = { item = 'aluminum', price = 15, label = 'aluminum', icon = 'aluminum', iconColor = '', quantity = 20, min = 20, max = 20 },
            [3] = { item = 'iron', price = 30, label = 'iron', icon = 'iron', quantity = 500, iconColor = '', min = 24, max = 26 },
            [4] = { item = 'steel', price = 50, label = 'steel', icon = 'money', iconColor = '', quantity = 27, min = 29, max = 30 },
            [5] = { item = 'metalscrap', price = 100, label = 'metalscrap', icon = 'metalscrap', min = 35, iconColor = '', quantity = 35, max = 35 },
            -- See example below on how to add more items here:
...
Config.ClientRequests = {
    ...
    armDriver = false, -- Arm the driver with a weapon?
    ...
    sellAccount = 'cash', -- When selling a vehicle, how does player receive payment? (bank, cash, markedbills, etc)
...
Config.Blips = {
    ...
    contract = {
        radius = { size = 200.0, color = 1, alpha = 100 }
    },
