...
--- @param data table .count, .requireItem, .requiredItem, .removeItem, .label, .removeRequired, .addItem, .max, .rollDuration, .removeQuantity, .addQuantity
CanRollJoint = function(data)
    return true
end
