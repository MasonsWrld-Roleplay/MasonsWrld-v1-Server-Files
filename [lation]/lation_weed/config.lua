...
-- True if yes, false if no
Config.CollisionCheck = true

-- Every plant by default has a "destroy" option
-- That anybody can use when interacting with a plant
-- If you only want the plants owner to see the destroy option
-- Then set AllowAllDestroy to false
-- (Police will always have a destroy option regardless of this option)
Config.AllowAllDestroy = true
...
Config.Police = {
    ...
    count = 0, -- If require = true, how many should be online?
...
Config.Shop = {
    ...
    location = vec4(-939.11, -1186.25, 3.93, 24.89),
    ...
    hour = { min = 1, max = 24 },
    account = 'bank', -- Use cash or bank when purchasing here?
    items = {
...
Config.SeedFarms = { -- The location(s) at which seeds are obtained
    [1] = {
        ...
        center = vec3(2225.805, 5576.971, 53.857), -- The center-most coords of the zone here
