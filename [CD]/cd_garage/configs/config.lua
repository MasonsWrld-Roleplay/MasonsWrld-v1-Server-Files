...
Config.TransferGarage = {
    ...
    transfer_fee = 100 --The cost per vehicle garage transfer ^.
}
...
Config.JobVehicles = {
    ...
    Locations = {
        ...
        ['police'] = { --If you choose to add more tables here for more jobs, they must be the jobs name, not the label.
            --MISSION ROW PD
            [1] = {coords = vector3(-588.65, -408.5, 31.16), spawn_coords = vector4(-588.46, -408.37, 31.16, 265.23), distance = 10, garage_type = 'car', method = 'regular'}, --Mission Row PD (cars)
            [2] = {coords = vector3(-595.78, -431.76, 51.38), spawn_coords = vector4(-595.78, -431.76, 51.38, 12.84), distance = 5, garage_type = 'air', method = 'regular'}, --Mission Row PD (helipad)
            --SANDY PD
        ...
        ['ambulance'] = {
            --PILLBOX HOSPITAL
            [1] = {coords = vector3(-816.69, -1201.06, 6.93), spawn_coords = vector4(-821.83, -1196.78, 6.82, 144.14), distance = 10, garage_type = 'car', method = 'regular'}, --Pillbox Hospital (cars)
            [2] = {coords = vector3(-789.57, -1192.2, 53.03), spawn_coords = vector4(-789.57, -1192.2, 53.03, 57.59), distance = 10, garage_type = 'air', method = 'regular'}, --Pillbox Hospital (helipad)
            --Sandy MEDICAL
    ...
    RegularMethod = {
        ...
        ['police'] = {
            [1] = {job = 'Audi A4 Unmarked', spawn_max = true, plate = 'PD', job_grade = 3, garage_type = 'car', model = `audia4unmarked`},
            [2] = {job = 'Audi A6M', spawn_max = true, plate = 'PD', job_grade = 3, garage_type = 'car', model = `23a6m`},
            [3] = {job = 'Audi RS5 Unmarked', spawn_max = true, plate = 'PD', job_grade = 3, garage_type = 'car', model = `ucrs5els`},
            [4] = {job = 'BMW 450 Unmarked', spawn_max = true, plate = 'PD', job_grade = 3, garage_type = 'car', model = `bmw540unmarked`},
            [5] = {job = 'BMW 530i Unmarked', spawn_max = true, plate = 'PD', job_grade = 3, garage_type = 'car', model = `BMW 530i Unmarked`},
            [6] = {job = 'BMW e90 marked', spawn_max = true, plate = 'PD', job_grade = 2, garage_type = 'car', model = `e90mark`},
            [7] = {job = 'BMW G31', spawn_max = true, plate = 'PD', job_grade = 2, garage_type = 'car', model = `BMW G31`},
            [8] = {job = 'BMW I3 Patrol', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polbmwi3`},
            [9] = {job = 'BMW M3 Marked', spawn_max = true, plate = 'PD', job_grade = 4, garage_type = 'car', model = `m3tels`},
            [10] = {job = 'BMW x5', spawn_max = true, plate = 'PD', job_grade = 2, garage_type = 'car', model = `sz_2024x5_pol`},
            [12] = {job = 'BMW x7 Unmarked', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `ucx7`},
            [13] = {job = 'Dodge SRT Markedt', spawn_max = true, plate = 'PD', job_grade = 7, garage_type = 'car', model = `markedsrt`},
            [14] = {job = 'marked evox', spawn_max = true, plate = 'PD', job_grade = 6, garage_type = 'car', model = `marked_els_evox`},
            [15] = {job = 'Ford Ranger', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `polranger`},
            [16] = {job = 'Ford Wagon Marked', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `polfordwagonmarked`},
            [17] = {job = 'Jaguar XFR Unmarked', spawn_max = true, plate = 'PD', job_grade = 3, garage_type = 'car', model = `jagrsunmarked`},
            [19] = {job = 'Marked BMW Bike', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `m1000mne`},
            [20] = {job = 'Merc GLS63', spawn_max = true, plate = 'PD', job_grade = 4, garage_type = 'car', model = `gls63mark`},
            [21] = {job = 'riotvan', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `riotvan`},
            [22] = {job = 'Mercedes Benz S63', spawn_max = true, plate = 'PD', job_grade = 8, garage_type = 'car', model = `Mercedes Benz S63`},
            [23] = {job = 'Merc Sprinter Van', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polmercsprinter`},
            [24] = {job = 'mitsubishi evo8', spawn_max = true, plate = 'PD', job_grade = 5, garage_type = 'car', model = `evo8mark`},
            [25] = {job = 'Mitsubushi Outlander', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `poloutlander`},
            [26] = {job = 'Mustang Electic', spawn_max = true, plate = 'PD', job_grade = 4, garage_type = 'car', model = `Mustang Electic`},
            [27] = {job = 'Nissan GTR Marked', spawn_max = true, plate = 'PD', job_grade = 10, garage_type = 'car', model = `gtr35mark`},
            [28] = {job = 'Ford Wagon UnMarked', spawn_max = true, plate = 'PD', job_grade = 3, garage_type = 'car', model = `polfordwagonunmarked`},
            [29] = {job = 'BMW 330D Response', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `polresponse`},
            [30] = {job = 'Police Bike Marked', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `policeb`},
            [31] = {job = 'Police Ford Pride Van', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `polpride`},
            [32] = {job = 'Police Kawasaki Bike UnMarked', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `polkawasakiunmarked`},
            [33] = {job = 'Police Mitsubishi Evo 09', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `polmitsubishi`},
            [34] = {job = 'Police Box Carrier', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `polcarrier`},
            [35] = {job = 'Police TFL Van', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `tflvan`},
            [36] = {job = 'Police Vauxhall Insignia VXR', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `polvxr`},
            [37] = {job = 'Police Volkswagen Marked', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `apex3`},
            [38] = {job = 'range_police_svr_els', spawn_max = true, plate = 'PD', job_grade = 2, garage_type = 'car', model = `range_police_els`},
            [39] = {job = 'Ranger Discovery Marked', spawn_max = true, plate = 'PD', job_grade = 3, garage_type = 'car', model = `poldisco`},
            [40] = {job = 'Santa Fe Beacon', spawn_max = true, plate = 'PD', job_grade = 0, garage_type = 'car', model = `Santa_Fe`},
            [41] = {job = 'Bearcat', spawn_max = true, plate = 'PD', job_grade = 8, garage_type = 'car', model = `sz_bearcat`},
            [42] = {job = 'touaregarv', spawn_max = true, plate = 'PD', job_grade = 2, garage_type = 'car', model = `touaregarv`},
            [43] = {job = 'Volvo V40 Area Patrol', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'car', model = `polvol40`},
            [44] = {job = 'Volvo XC90 Unmarked', spawn_max = true, plate = 'PD', job_grade = 2, garage_type = 'car', model = `xc90NE`},
            [45] = {job = 'Markeda45', spawn_max = true, plate = 'PD', job_grade = 2, garage_type = 'car', model = `Markeda45`},



            [46] = {job = 'Air 1', spawn_max = true, plate = 'PD', job_grade = 3, garage_type = 'air', model = `ec135`},

            [47] = {job = 'police boat', spawn_max = true, plate = 'PD', job_grade = 1, garage_type = 'boat', model = `predator`},
        },
        ['ambulance'] = {
            [1] = {job = 'NHS Doctor Land Rover', spawn_max = true, plate = 'NHS', job_grade = 3, garage_type = 'car', model = `nhsdoctorlandrover`},
            [2] = {job = 'NHS Fiat Ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsfiatvan`},
            [3] = {job = 'NHS Land Rover Discovery', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhslandrover`},
            [4] = {job = 'NHS Mercedes 2', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsmercedes2`},
            [5] = {job = 'NHS Mercedes Ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsmercedes`},
            [6] = {job = 'NHS Motorbike', spawn_max = true, plate = 'NHS', job_grade = 1, garage_type = 'car', model = `nhsbike`},
            [7] = {job = 'NHS Mountain Ambulance', spawn_max = true, plate = 'NHS', job_grade = 1, garage_type = 'car', model = `nhsmountainambulance`},
            [8] = {job = 'NHS Skoda', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsskoda`},
            [9] = {job = 'NHS Skoda Octavia vRS Estate', spawn_max = true, plate = 'NHS', job_grade = 2, garage_type = 'car', model = `nhsskodavrs`},
            [10] = {job = 'NHS Skoda Van', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsskodavan`},
            [11] = {job = 'NHS Volkswagon Touran', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `nhsvol`},
            [12] = {job = 'NHS Volvo XC90', spawn_max = true, plate = 'NHS', job_grade = 2, garage_type = 'car', model = `nhsvolvo`},
            [13] = {job = 'ST John Ambulance', spawn_max = true, plate = 'NHS', job_grade = 0, garage_type = 'car', model = `stjohnambulance`},


            
            [8] = {job = 'nhs heli', spawn_max = true, plate = 'NHS', job_grade = 3, garage_type = 'air', model = `ec135`},
        },
    }
}
