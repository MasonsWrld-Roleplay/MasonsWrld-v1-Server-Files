Config.Shop['taco'] = { -- job name
	blip = {enable = true, name = 'Taco', sprite = 79, color = 5, size = 0.6, radius = 0.0, radius_color = 4},
	boss_action = vector3(8.2, -1606.31, 29.36),
	management = vector3(8.2, -1606.31, 29.36),
	managementRankFor = {
		price = 4,
		stock = 4,
	},
	...
	crafting = {
		menu = vector3(8.18, -1603.14, 29.36),
		data = {
			beefy_nacho = { 										-- reward item name
				reward = 7,										-- reward item amount
				required = {									-- required items for crafting
					--{item = 'water', quantity = 1, willremove = false}, 
					--{item = 'bread', quantity = 2, willremove = true},
				},
				steps = {
					{pos = vector4(11.13, -1599.65, 29.36, 48.75),  delay = 30, msg = 'Working...'},	-- x, y, z, heading, second, message
					{pos = vector4(11.13, -1599.65, 29.36, 48.75),  delay = 30, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			...
			crunchwrap_supreme_meal = { 										-- reward item name
				...
				steps = {
					{pos = vector4(11.13, -1599.65, 29.36, 48.75),  delay = 30, msg = 'Working...'},	-- x, y, z, heading, second, message
					{pos = vector4(11.13, -1599.65, 29.36, 48.75),  delay = 30, msg = 'Working...'},	-- x, y, z, heading, second, message
					{pos = vector4(11.13, -1599.65, 29.36, 48.75),  delay = 10, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			...
			t_diet_pepsi = { 										-- reward item name
				...
				steps = {
					{pos = vector4(9.78, -1604.39, 29.36, 229.67),  delay = 10, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
	...
	storage = {
		pos = vector4(13.57, -1596.3, 29.36, 49.56), 		-- x, y, z, heading
		prop = nil,
		items = {
