Config.Shop['chickfila'] = { -- job name
	blip = {enable = false, name = 'GoodysBurgers', sprite = 536, color = 21, size = 0.5, radius = 0.0, radius_color = 4},
	boss_action = vector3(-547.84, -858.81, 30.24),
	management = vector3(-535.97, -866.77, 30.23),
	managementRankFor = {
		price = 2,
		stock = 2,
	},
	...
	crafting = {
		menu = vector3(-545.96, -863.53, 30.24),
		data = {
			asain_zest_wings = { 										-- reward item name
				...
				steps = {
					{pos = vector4(-542.22, -863.64, 30.24, 3.34),  delay = 20, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			atomic_wings = { 										-- reward item name
				...
				steps = {
					{pos = vector4(-543.77, -866.2, 30.24, 179.64),  delay = 20, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
	...
	storage = {
		pos = vector4(-542.58, -856.58, 30.24, 350.87), 		-- x, y, z, heading
		prop = nil,
		items = {
	...
	vector3(-533.38, -864.55, 30.23),
	vector3(-533.44, -868.15, 30.23),
	},
	data = {
