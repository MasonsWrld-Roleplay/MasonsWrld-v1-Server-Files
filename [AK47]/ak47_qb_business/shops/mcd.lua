Config.Shop['mcdonalds'] = { -- job name
	blip = {enable = true, name = 'McDonalds', sprite = 124, color = 5, size = 0.6, radius = 0.0, radius_color = 4},
	boss_action = vector4(84.41, 293.61, 110.21, 35.12),
	management = vector3(88.66, 291.44, 110.21),
	managementRankFor = {
		price = 2,
		stock = 2,
	},
	...
	crafting = {
		menu = vector3(89.91, 296.62, 110.21),
		data = {
			big_mac = { 										-- reward item name
				reward = 4,										-- reward item amount
				required = {									-- required items for crafting
					--{item = 'water', quantity = 1, willremove = false}, 
					--{item = 'bread', quantity = 2, willremove = true},
				},
				steps = {
					{pos = vector4(95.3, 294.32, 110.21, 338.78),  delay = 20, msg = 'Working...'},	-- x, y, z, heading, second, message
					{pos = vector4(95.3, 294.32, 110.21, 338.78),  delay = 20, msg = 'Working...'},	-- x, y, z, heading, second, message
					{pos = vector4(95.3, 294.32, 110.21, 338.78),  delay = 30, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			...
			sausage_burrito = { 										-- reward item name
				...
				steps = {
					{pos = vector4(95.05, 294.29, 110.21, 347.74),  delay = 20, msg = 'Working...'},	-- x, y, z, heading, second, message
					{pos = vector4(95.05, 294.29, 110.21, 347.74),  delay = 20, msg = 'Working...'},	-- x, y, z, heading, second, message
					{pos = vector4(95.05, 294.29, 110.21, 347.74),  delay = 30, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			...
			hot_fudge_sundae = { 										-- reward item name
				...
				steps = {
					{pos = vector4(94.92, 289.65, 110.21, 257.68),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			mc_cappuccino = { 										-- reward item name
				...
				steps = {
					{pos = vector4(96.15, 292.8, 110.21, 242.62),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			mc_coca_cola = { 										-- reward item name
				...
				steps = {
					{pos = vector4(95.68, 291.49, 110.21, 251.67),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			...
			mc_flurry_candies = { 										-- reward item name
				...
				steps = {
					{pos = vector4(94.7, 289.71, 110.21, 252.84),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			...
			mc_fruit_punch = { 										-- reward item name
				...
				steps = {
					{pos = vector4(95.68, 291.71, 110.21, 276.4),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			mc_hot_chocolate = { 										-- reward item name
				...
				steps = {
					{pos = vector4(96.2, 292.92, 110.21, 245.99),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			mc_iced_coffee = { 										-- reward item name
				...
				steps = {
					{pos = vector4(96.17, 292.81, 110.21, 247.26),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			...
			mc_sprite = { 										-- reward item name
				...
				steps = {
					{pos = vector4(95.67, 291.65, 110.21, 245.73),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			mc_strawberry_shake = { 										-- reward item name
				...
				steps = {
					{pos = vector4(94.99, 289.79, 110.21, 232.7),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			...
			orange_juice = { 										-- reward item name
				...
				steps = {
					{pos = vector4(95.67, 291.73, 110.21, 255.7),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			strawberry_watermelon_slushie = { 										-- reward item name
				...
				steps = {
					{pos = vector4(95.15, 290.34, 110.21, 258.93),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
	...
	storage = {
		pos = vector4(275.98, -973.67, 29.37, 140.83), 		-- x, y, z, heading
		prop = nil,
		items = {
			world_famous_fries = {
