...
RegisterNetEvent('ak47_qb_whitewidowv2:notify')
AddEventHandler('ak47_qb_whitewidowv2:notify', function(msg)
    QBCore.Functions.Notify(msg)
end)

RegisterNetEvent('ak47_qb_whitewidowv2:progress')
AddEventHandler('ak47_qb_whitewidowv2:progress', function(msg, time)
    lib.progressCircle({
        duration = time,
        label = msg,
    })
