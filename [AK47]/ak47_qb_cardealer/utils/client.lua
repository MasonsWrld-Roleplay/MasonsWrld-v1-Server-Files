...
Citizen.CreateThread(function()
    ...
    Citizen.Wait(2000)
    TriggerServerEvent('ak47_qb_cardealer:init')
    TriggerEvent('chat:addSuggestion', '/'..Config.Commands.adddealerjob, _U('cmdadddealerjob'), {})
    TriggerEvent('chat:addSuggestion', '/'..Config.Commands.createdealer, _U('cmdcreatedealer'), {})
    TriggerEvent('chat:addSuggestion', '/'..Config.Commands.deletedealer, _U('cmddeletedealer'), {})
    TriggerEvent('chat:addSuggestion', '/'..Config.Commands.adddisplay, _U('cmdadddisplay'), {})
end)
...
RegisterNetEvent('ak47_qb_cardealer:notify', function(msg)
