Citizen.CreateThread(function()
    ...
    TriggerEvent('chat:addSuggestion', '/'..Config.Commands.createshop, _U('cmdcreateshop'), {})
    TriggerEvent('chat:addSuggestion', '/'..Config.Commands.deleteshop, _U('cmddeleteshop'), {})
    TriggerServerEvent('ak47_qb_playershop:init')
    TriggerServerEvent('ak47_qb_playershop:playerload')
end)

RegisterNetEvent('ak47_qb_playershop:notify', function(msg, type)
	--[[
	type:
		success
		warning
